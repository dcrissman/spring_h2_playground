...
public class UserDao2TransactionManaged implements UserDao {

    private final static Logger LOGGER = LoggerFactory.getLogger(UserDao2TransactionManaged.class);

    private final EntityManager mgr;
    private final PlatformTransactionManager transactionManager;

    public UserDao2TransactionManaged(
